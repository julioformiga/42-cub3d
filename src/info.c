...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2025/04/19 15:15:50 by julio.formiga     #+#    #+#             */
/*   Updated: 2025/04/19 15:15:50 by julio.formiga    ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	map_render_info(t_env *env)
{
	...
	ft_mlx_draw_line(env, (t_point){0, 0}, (t_point){WIN_WIDTH, 0},
		border_color);
	ft_mlx_draw_line(env, (t_point){0, WIN_HEIGHT - 1},
		(t_point){WIN_WIDTH, WIN_HEIGHT - 1}, border_color);
	ft_mlx_draw_line(env, (t_point){0, 0},
		(t_point){0, WIN_HEIGHT}, border_color);
	ft_mlx_draw_line(env, (t_point){WIN_WIDTH - 1, 0},
		(t_point){WIN_WIDTH - 1, WIN_HEIGHT}, border_color);
